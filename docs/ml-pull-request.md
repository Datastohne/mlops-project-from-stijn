...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops-project-from-stijn-run-tests-fs.yml) 
...
* [Staging workspace registered model](https://adb-4301376284584187.7.azuredatabricks.net#mlflow/models/staging-mlops-project-from-stijn-model)
* [Prod workspace registered model](https://adb-3011150083119087.7.azuredatabricks.net#mlflow/models/prod-mlops-project-from-stijn-model)

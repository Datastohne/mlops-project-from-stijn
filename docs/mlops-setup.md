...
[ML Config](../mlops_project_from_stijn/databricks-resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore mlops_project_from_stijn/databricks-resources/README.md
...
Follow the instructions in [mlops-project-from-stijn/databricks-resources/README.md](../mlops_project_from_stijn/databricks-resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../mlops_project_from_stijn/databricks-resources/README.md)  to propose, test, and deploy

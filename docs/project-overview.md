...
```
mlops-project-from-stijn         <- Root directory. Both monorepo and polyrepo are supported.
│
├── mlops_project_from_stijn       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │

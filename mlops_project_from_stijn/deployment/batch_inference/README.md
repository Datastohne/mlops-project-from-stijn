# Batch Inference
To set up batch inference job via scheduled Databricks workflow, please refer to [mlops_project_from_stijn/databricks-resources/README.md](../../databricks-resources/README.md)
